...
| 90 ADR | [shared/90-adr/README.md](shared/90-adr/README.md) | 아키텍처 의사결정 인덱스 | 2026-08-29 |
| 용어집 | [shared/glossary.md](shared/glossary.md) | 도메인 용어 정의 | 2026-08-31 |
...
| 아키텍처 의사결정 배경 | `docs/shared/90-adr/README.md` |
...
| `cryptoengine/scripts/init_db.py` | `40-data/data-model.md`, `docs/shared/90-adr/0006-db-migration-tracks.md` |
...
| `cryptoengine/shared/db/**` | [40-data/data-model.md](40-data/data-model.md) · [shared/90-adr/0006-db-migration-tracks.md](shared/90-adr/0006-db-migration-tracks.md) |
| `cryptoengine/scripts/init_db.py` | [40-data/data-model.md](40-data/data-model.md) · [shared/90-adr/0006-db-migration-tracks.md](shared/90-adr/0006-db-migration-tracks.md) |
