...
```
하드 캡: 5x 레버리지 (변경 불가)
현재 설정: supertrend_4h_x3_173 (Supertrend 4h Long-only, 3x 레버리지)
MAX_LEVERAGE 코드 상한: 3 (shared/exchange/bybit.py)
```

---

## 현재 설정: supertrend_4h_x3_173 (Phase 5, 2026-05-18~)
...
```
CAGR:           +128.93%    ✅ 매우 높음
Sharpe 비율:    1.30        ⚠️ 적절 (> 1.0)
최대낙폭(MDD):  -86.94%     ⚠️ 극한 위험 (사용자 승인)
거래 수:        378회       ✅ 충분한 샘플
```
...
| supertrend_4h_x3_173 | 2026-05-18~ | **3x** | ✅ **현재 운영** |
...
```
supertrend_4h_x3_173 기준 ($95,000 BTC 가정):
  - 할당 자본: $60 (ranging 30%)
...
장기 누적 드로우다운(MDD -86.94%)은 시스템적 손실로 SL으로 막을 수 없음.
