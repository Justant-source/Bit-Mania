"""B2용: BTC 3거래소 6년치 펀딩비 + OHLCV 수집.

Track B 백테스트 인프라: Cross-exchange FA 데이터 집계.
BTC 단일 운영 정책 준수 (다중 심볼 금지).
"""
import sys
...
def fetch_and_store(client: CoinalyzeClient):
    """Fetch BTC funding rates and OHLCV from 3 exchanges, store in PostgreSQL."""
