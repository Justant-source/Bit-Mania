...
BATCH_META = {
    ...
    2: {
        ...
        'strategies': ['momentum_ma', 'supertrend', 'tradeiq_220320'],
        'names': ['MomentumMA', 'Supertrend', 'TradeIQ220320'],
        'category': 'Trend Following',
        'prior_note': 'CryptoEngine 004 trend following은 -1.84% (수수료 > alpha)로 폐기됨',
    },
    3: {
        'title': 'Batch 3 — Hybrid / Regime 종합',
        'strategies': ['trendtype', 'supertrend_trendtype', 'tradeiq_220323'],
        'names': ['TrendType', 'SupertrendTrendType', 'TradeIQ220323'],
