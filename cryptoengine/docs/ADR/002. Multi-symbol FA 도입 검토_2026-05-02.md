...
date: 2026-05-02
related_code:
  - cryptoengine/services/jesse_engine/strategies/multi_symbol_funding_arb.py
  - cryptoengine/services/jesse_engine/strategies/cross_exchange_fa.py
  - cryptoengine/services/jesse_engine/strategies/dynamic_threshold_fa.py
  - cryptoengine/services/jesse_engine/scripts/data/fetch_multi_symbol.py
  - cryptoengine/services/jesse_engine/scripts/data/fetch_multi_exchange.py
---
...
PROPOSED (2026-05-02) — 백테스트 결과 기다리는 중
...
**데이터 수집 스크립트**:
```
cryptoengine/services/jesse_engine/scripts/data/
