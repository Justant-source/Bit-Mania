...
| 항목 | 내용 |
|------|------|
| 전략 | 7개 (supertrend, trendtype, supertrend_trendtype, tradeiq_psar_ha, tradeiq_cci_ce, stoch, momentum_ma) |
...
| **tradeiq_psar_ha** | 32 | **+22.12** | 1D/long_only | ✅ KEEP |
| **tradeiq_cci_ce** | 19 | **+17.27** | 4h/bidirectional | ✅ KEEP (조건부) |
| **stoch** | **0** | -999 | — | ❌ DELETE |
...
| **tradeiq_psar_ha** | 1D | long_only | +30.01% | 1.081 | -27.36% | 72 |
...
| **tradeiq_cci_ce** | 4h | bidirectional | +14.65% | 0.665 | -32.19% | 108 |
| **tradeiq_cci_ce** | 4h | long_only | +11.25% | 0.598 | -32.58% | 83 |
| **supertrend** | 1h | long_only | +10.46% | 0.483 | -33.12% | 981 |
| **tradeiq_cci_ce** | 1h | long_only | +6.60% | 0.452 | -26.09% | 187 |
...
| TF | 특징 |
|----|------|
| **1D** | 고수익 고품질. supertrend(+33%), tradeiq_psar_ha(+30%), trendtype(+23%) — Sharpe 1.0+ |
...
- **예외**: trendtype/1D, tradeiq_cci_ce/4h → 이 두 조합은 bidirectional도 유효
...
| tradeiq_psar_ha/1D | +16.4% | +29.5% | +13.1%p | 중간 |
| tradeiq_cci_ce/4h bidir | +15.3% | +20.6% | +5.3%p | 진입시점 가장 독립적 ✓ |

> **supertrend_trendtype**과 **tradeiq_cci_ce**은 진입 시점에 가장 덜 민감 — 임의 시점 투자 시 유리.
...
| 4 | tradeiq_psar_ha/1D/long_only | -27.36% |
| 5 | supertrend_trendtype/4h/long_only | -29.05% |
| 6 | tradeiq_cci_ce/4h/bidirectional | -32.19% |
...
| tradeiq_psar_ha | rsi_len=18 / 1D | +29.94% | rsi_len=18, atr_mult=**4.0** / 1D | +30.01% | +0.07%p |
| supertrend_trendtype | st_factor=2.0 / 4h | +33.44% | 동일 (st_factor=2.0, atr_len=10) | +33.44% | 변화 없음 |
| tradeiq_cci_ce | baseline 유지 | — | cci=20, ce=3.0 / 4h bidir | +14.65% | 신규 발굴 |
...
| tradeiq_psar_ha | 1D | long_only | +30.01% | 1.081 | -27.36% | 1D 안정형 |
...
| tradeiq_cci_ce | 4h | bidirectional | +14.65% | 0.665 | -32.19% | 진입시점 독립, 리스크 분산 |
...
| tradeiq_cci_ce/1D | trades ≤ 10으로 통계적 신뢰도 낮음 |
...
1. 롤링 윈도우 재검증 (Tier 1 조합 대상)
   python3 cryptoengine/services/jesse_engine/scripts/rolling_window_analysis.py \
     --strategies supertrend supertrend_trendtype tradeiq_psar_ha trendtype \
     --skip-plots
