...
class SupertrendStrategy(Strategy):
    ...
    def hyperparameters(self):
        return [
            ...
            {'name': 'st_period',        'type': int,   'min': 5,   'max': 16,   'default': 7},
            {'name': 'fast_ema_len',     'type': int,   'min': 3,   'max': 16,   'default': 7},
            {'name': 'slow_ema_len',     'type': int,   'min': 15,  'max': 40,   'default': 20},
            {'name': 'direction_ema_len','type': int,   'min': 100, 'max': 450,  'default': 200},
