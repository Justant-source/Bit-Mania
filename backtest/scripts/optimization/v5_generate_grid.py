#!/usr/bin/env python3
"""
v5_generate_grid.py — 324 combo × 8 window = 2,592 job SQLite 큐 생성

v4 dense-grid 후속. combo_70(v4 winner) 인근 forward-shift 탐색:
  dir_ema=200 제거 → 230/250; fast_ema=7 제거 → 9/10/11; slow_ema=20 제거 → 25/30
  st_period=5 제거 → 6/7/8; atr=2.5 제거 → 3.0/3.2/3.5
  3×3×3×2×2×3 = 324. sl_margin_pct=0.0 고정 (v4 동일 조건).
