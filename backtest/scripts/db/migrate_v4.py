"""Migrate v4 optimization results to database."""
import csv
import json
...
def main():
    """Load v4 optimization CSV and populate database."""
    csv_path = '/result/v4_optimization/v4_all_combos.csv'
    ...
    upsert_sweep(
        conn,
        sweep_id='v4',
        description='v4 grid (216 combos, 4×3×3×3×3×1)',
        leverage=3,
        variant='long_only',
        grid_json=None,
        n_combos=216,
    ...
    with open(csv_path, 'r') as f:
        ...
        for row in reader:
            ...
            # Parse windows first to build combo data
            ...
            pk = upsert_combo(conn, 'v4', combo_data)
    ...
    conn.close()
    print(f'v4 migration complete: {row_count} combos loaded')
